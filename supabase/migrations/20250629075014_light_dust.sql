/*
  ...
  1. New Tables
    - `certificate_templates` - Store custom certificate designs
    - Enhanced `certificates` table with template and data fields
    - Enhanced `course_purchases` with revenue tracking
    - `student_progress` - Track detailed student progress

  2. Views
    - `instructor_analytics` - Comprehensive instructor metrics
    - `course_progress_analytics` - Student progress analytics

  3. Functions & Triggers
    - Auto-calculate instructor revenue (90/10 split)
    - Enhanced certificate generation with templates
    - Progress tracking automation

  4. Security
    - RLS policies for certificate templates
    - Proper access controls for instructor data
*/
