/*
# Phase 2: Instructor Experience Enhancement
...
2. Enhanced Tables
   - `certificates` - Added template_id and certificate_data fields
   - `course_purchases` - Added revenue tracking fields

3. Analytics Views
   - `instructor_analytics` - Revenue and student metrics per course
   - `course_progress_analytics` - Detailed progress analytics

4. Security
   - Enable RLS on new tables
   - Add policies for student progress and certificate templates

5. Functions & Triggers
   - Enhanced certificate auto-issuance
   - Revenue calculation on payment completion
...
-- Insert default certificate template (only if it doesn't exist)
